...
def get_user_dashboard_url(user):
    ...
    if user.is_superuser or user.groups.filter(name='Administrador').exists():
        return reverse('inventario:dashboard_admin')
    elif user.groups.filter(name='Activos Informáticos').exists():
    ...
    elif user.groups.filter(name='Activos Generales').exists():
        return reverse('inventario:dashboard_generales')
    else:
